...
class PitchModelTest(unittest.TestCase):
    '''
    Test case that checks whether the comments have been saved. 
    '''
    def setUp(self):
        self.user_Trial= User(username='Joyce',password ='potato',email ='joyce@gmail.com')
